...
public class SucursalesRepository {
        ...
        public List<ProvinciaBean> obtenerProvincias(String codPais) {
                ...
                return jdbcCallFactory.executeQuery("obtener_provincias", "dbo", params, "provincias",
                                ProvinciaBean.class);
        ...
        public List<LocalidadBean> obtenerLocalidades(LocalidadesRequest req) {
                ...
                return jdbcCallFactory.executeQuery("obtener_localidades", "dbo", params, "localidades",
                                LocalidadBean.class);
        }
        ...
        public List<SucursalBean> obtenerSucursalesLocalidad(SucursalesLocalidadesRequest req) {
                try {
                        ...
                        SqlParameterSource params = new MapSqlParameterSource()
                                        ...
                                        .addValue("lista_supermercados", supermercados);

                        return jdbcCallFactory.executeQuery("obtener_sucursales_por_localidad", "dbo", params,
                                        "sucursalesLocalidad",
                                        SucursalBean.class);
