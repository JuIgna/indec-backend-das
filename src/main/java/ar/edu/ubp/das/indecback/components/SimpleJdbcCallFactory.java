...
public class SimpleJdbcCallFactory {
    ...
    public Integer executeQueryForSingleResult(String procedureName, String schemaName, SqlParameterSource params) {
        SimpleJdbcCall jdbcCall = createCall(procedureName, schemaName)
                .returningResultSet("result", (rs, rowNum) -> rs.getInt("nro_localidad"));

        Map<String, Object> result = jdbcCall.execute(params);
        List<Integer> resultList = (List<Integer>) result.get("result");
