...
package ar.edu.ubp.das.supermercadows2.config;
...
public class WebServiceConfig {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema mySchema) {
        ...
        wsdl11Definition.setPortTypeName("SupermercadoWS2Port");
        wsdl11Definition.setLocationUri("/services");

        wsdl11Definition.setTargetNamespace("http://services.supermercadows2.das.ubp.edu.ar/");
    ...
    public XsdSchema mySchema() {
        return new SimpleXsdSchema(new ClassPathResource("SupermercadoWS2_schema1.xsd"));
    }
