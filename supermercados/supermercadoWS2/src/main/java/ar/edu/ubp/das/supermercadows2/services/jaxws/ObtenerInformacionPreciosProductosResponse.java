...
@XmlRootElement(name = "ObtenerInformacionPreciosProductosResponse", namespace = "http://services.supermercadows2.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ObtenerInformacionPreciosProductosResponse", namespace = "http://services.supermercadows2.das.ubp.edu.ar/")
