...
@XmlRootElement(name = "ObtenerInformacionCompletaProductosResponse", namespace = "http://services.supermercadows2.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ObtenerInformacionCompletaProductosResponse", namespace = "http://services.supermercadows2.das.ubp.edu.ar/")
